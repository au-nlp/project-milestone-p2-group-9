...
- Although retrieval-augmented generation (RAG) was discussed in the P2 plan, the current P3 implementation adopts a summary-centric pipeline, where summaries are generated first and then used for downstream analysis
